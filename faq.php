    ...
    <div id="page-content" class="page-content">
        ...
        <section id="faq">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p><strong>1. What is E-Commerce?</strong></p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis consequuntur recusandae, maxime perspiciatis modi, quisquam laudantium accusantium aliquid alias reprehenderit eligendi ratione nesciunt quos dignissimos fugit totam esse atque magni.</p>
                        <p><strong>2. What stores are supported?</strong></p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique deleniti, laborum asperiores quibusdam repellendus dolore sed voluptas reprehenderit rerum odio quas provident exercitationem, sapiente doloribus tenetur nisi soluta voluptatibus. Repellat?
                        </p>
                        <p><strong>3. Do you serve my area?</strong></p>
                        <p>Currently we serve the Greater Noida, Delhi, NCR, Gurgaon and Noida as well as Banglore and Channai. Check if we deliver to your area by downloading the App or using our Website. You can type your address and see the list of stores available. We keep adding stores on a regular basis! If your favorite store is not listed you can suggest it to us via the &nbsp;“Request New Stores” button at the bottom of the&nbsp; supermarkets list.</p>
                        ...
                        <p>It costs Rs. 20 for the&nbsp;delivery on all delivery slots. And FREE DELIVERY for order placed above Rs. 50  in May 2017 only</p>
                        ...
                        <p>Contact us! We will be there at support.E-Commerce@domain.com.</p>
