    ...
    if(isset($_POST['submit'])) {
        ...
        if(empty($_POST['fullname']) OR empty($_POST['email']) OR empty($_POST['password']) OR empty($_POST['username'])) {
            ...
            if($_POST['password'] == $_POST['confirm_password']) {
               ...
               // header("Location: http://localhost/E-commerce/auth/login.php");
...
?>
    ...
    <div id="page-content" class="page-content">
        <div class="banner">
            <div class="jumbotron jumbotron-bg text-center rounded-0" style="background-image: url('<?php echo APPURL; ?>/assets/img/bg_register.jpg');">
                <div class="container">
                    <h1 class="pt-5">
                        Register Page
                    </h1>
