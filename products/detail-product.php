...
<?php 
    ...
    if(isset($_GET['id'])) {
        ...
        //relatedproducts
        $relatedProducts = $conn->query("SELECT * FROM products WHERE category_id = '$product->category_id' AND id != '$id'");
    ...
    if(isset($_POST['submit'])) {
        ...
        $insert = $conn->prepare("INSERT INTO cart (pro_id, pro_title, pro_image, product_price, pro_qty, pro_subtotal, user_id) 
        VALUES (:pro_id, :pro_title, :pro_image, :product_price, :pro_qty, :pro_subtotal, :user_id)");
...
?>
    <div id="page-content" class="page-content">
        <div class="banner">
            <div class="jumbotron jumbotron-bg text-center rounded-0" style="background-image: url('<?php echo APPURL; ?>/assets/img/bg_detail.jpg');">
                <div class="container">
                    <h1 class="pt-5">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="slider-zoom">
                            <a href="http://localhost/E-commerce/assets/img/product/<?php echo $product->image; ?>" class="cloud-zoom" rel="transparentImage: 'data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==', useWrapper: false, showTitle: false, zoomWidth:'500', zoomHeight:'500', adjustY:0, adjustX:10" id="cloudZoom">
                                <img alt="Detail Zoom thumbs image" src="http://localhost/E-commerce/assets/img/product/<?php echo $product->image; ?>" style="width: 100%;">
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <form method="POST" id="form-data">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-sm-6"><span class="pt-1 d-inline-block">UK Size 9 Available</span></div> -->
                            </div>
                            <div class="row">
                                <div class="col-sm-5">
                                ...
                                <div class="item">
                                    <div class="card card-product">
                                        ...
                                        <div class="card-badge">
                                            ...
                                            <img src="http://localhost/E-commerce/assets/img/product/<?php echo $products->image; ?>" alt="Card image 2" class="card-img-top">
                                        </div>
                                        <div class="card-body">
                                            <h4 class="card-title">
