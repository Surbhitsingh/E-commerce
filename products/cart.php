...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        // header('location: http://localhost/E-commerce/products/checkout.php');
                                ...
                                <tbody>
                                  <?php if(count($allProducts) > 0) : ?>  
                                    <?php foreach($allProducts as $product) : ?>  
                                        <tr>
                                            <td>
                                                <img src="http://localhost/E-commerce/assets/img/product/<?php echo $product->pro_image; ?>" width="60">
                                            </td>
                                            <td>
                                            ...
                                            <td class="subtotal_price">
                                               <?php echo $product->product_price * $product->pro_qty; ?>
                                            </td>
                                            <td>
