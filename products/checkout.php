...
<?php 
    ...
    if(isset($_SESSION['price'])) {
        $_SESSION['total_price'] = (int) $_SESSION['price'] + 20 ;
    }
    ...
    if(isset($_POST['submit'])) {
        ...
        OR empty($_POST['order_notes'])) {
            ...
            VALUES(:name, :lname, :company_name, :address, :city, :country, :zip_code, :email, 
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <form action="checkout.php" method="POST" class="bill-detail">
                            ...
                            <button name="submit" type="submit" class="btn btn-primary float-left">PROCEED TO CHECKOUT </button>

                        </form>
                        <!-- Bill Detail of the Page end -->
                    </div>
                    <?php (int)$subtotal_price =0; ?>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach($allProducts as $product) : ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                &#8377; <?php echo $product->product_price; $subtotal_price = $subtotal_price +$product->product_price; ?>
                                    ...
                                    <tfooter>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <strong>&#8377; <?php echo (int)$_SESSION['price'] + 20; ?></strong>
                                            </td>
                                        </tr>
                                    </tfooter>
                                </table>
